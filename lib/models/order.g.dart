...
void _orderSerialize(
  ...
  writer.writeLong(offsets[1], object.idService);
...
Order _orderDeserialize(
  ...
  final object = Order(
    ...
    idService: reader.readLong(offsets[1]),
    time: reader.readString(offsets[2]),
...
extension OrderQueryFilter on QueryBuilder<Order, Order, QFilterCondition> {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> idServiceEqualTo(
      int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'idService',
        value: value,
      ));
    });
  }

  QueryBuilder<Order, Order, QAfterFilterCondition> idServiceGreaterThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> idServiceLessThan(
    int value, {
    bool include = false,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> idServiceBetween(
    int lower,
    int upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeEqualTo(
    String value, {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeGreaterThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeLessThan(
    String value, {
    bool include = false,
    bool caseSensitive = true,
  }) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeBetween(
    String lower,
    String upper, {
    bool includeLower = true,
    bool includeUpper = true,
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeStartsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeEndsWith(
    String value, {
    bool caseSensitive = true,
  }) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeContains(String value,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeMatches(String pattern,
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeIsEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'time',
        value: '',
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> timeIsNotEmpty() {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.greaterThan(
        property: r'time',
        value: '',
  ...
  QueryBuilder<Order, Order, QAfterFilterCondition> userIdEqualTo(int value) {
    return QueryBuilder.apply(this, (query) {
      return query.addFilterCondition(FilterCondition.equalTo(
        property: r'userId',
        value: value,
...
extension OrderQuerySortBy on QueryBuilder<Order, Order, QSortBy> {
  ...
  QueryBuilder<Order, Order, QAfterSortBy> sortByIdService() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idService', Sort.asc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> sortByIdServiceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idService', Sort.desc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> sortByTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.asc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> sortByTimeDesc() {
    return QueryBuilder.apply(this, (query) {
...
extension OrderQuerySortThenBy on QueryBuilder<Order, Order, QSortThenBy> {
  ...
  QueryBuilder<Order, Order, QAfterSortBy> thenByIdService() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idService', Sort.asc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> thenByIdServiceDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'idService', Sort.desc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> thenByTime() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.asc);
    });
  }

  QueryBuilder<Order, Order, QAfterSortBy> thenByTimeDesc() {
    return QueryBuilder.apply(this, (query) {
      return query.addSortBy(r'time', Sort.desc);
    });
  }
...
extension OrderQueryWhereDistinct on QueryBuilder<Order, Order, QDistinct> {
  ...
  QueryBuilder<Order, Order, QDistinct> distinctByIdService() {
    return QueryBuilder.apply(this, (query) {
      return query.addDistinctBy(r'idService');
    });
  }

  QueryBuilder<Order, Order, QDistinct> distinctByTime(
      {bool caseSensitive = true}) {
    return QueryBuilder.apply(this, (query) {
...
extension OrderQueryProperty on QueryBuilder<Order, Order, QQueryProperty> {
  ...
  QueryBuilder<Order, int, QQueryOperations> idServiceProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'idService');
    });
  }

  QueryBuilder<Order, String, QQueryOperations> timeProperty() {
    return QueryBuilder.apply(this, (query) {
      return query.addPropertyName(r'time');
    });
  }

  QueryBuilder<Order, int, QQueryOperations> userIdProperty() {
    return QueryBuilder.apply(this, (query) {
